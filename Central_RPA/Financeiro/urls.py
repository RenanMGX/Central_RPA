...
urlpatterns = [
    ...
    path('status_relatAberturaDesp', views.tarefa_status, name='status_relatAberturaDesp'),
    path('listaTarefas_relatAberturaDesp', views.lista_files, name='listaTarefas_relatAberturaDesp'),
]
